    ...
    >
      <div className="flex h-full flex-col">
        <div
          className={
            isCases
              ? "min-h-34 sm:min-h-36"
              : "min-h-32 sm:min-h-34"
          }
        >
          <div
            className={
          ...
          <div
            className={
              isCases
                ...
                : "mt-3 text-[1.65rem] leading-none font-semibold tracking-[-0.04em] text-slate-50 sm:text-[1.8rem]"
            }
          >
            {ticker}
          </div>
          ...
          <p
            className={
              isCases
                ...
                : "mt-4 max-w-sm text-sm leading-6 text-slate-100"
            }
          >
            {description}
          </p>
