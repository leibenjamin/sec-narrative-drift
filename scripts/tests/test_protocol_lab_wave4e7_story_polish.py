...
import protocol_lab_wave4e7_story_polish as wave  # noqa: E402


STAMP = "20990101_0555"


class Wave4E7StoryPolishPacketTest(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def test_generate_wave_builds_packet_and_includes_test_dependencies(self) -> None:
        ...
        self.assertTrue(summary.story_consistency_qa_added)
        self.assertTrue(summary.review_packet_test_completeness_improved)
        self.assertEqual(summary.biggest_remaining_blocker, wave.BIGGEST_REMAINING_BLOCKER)

        for relative_path in [
            "reports/protocol_lab/wave4e7_micro_usability_audit.md",
            "reports/protocol_lab/wave4e7_story_polish_report.md",
            "reports/protocol_lab/wave4e7_copy_decisions.md",
            "src/pages/Home.tsx",
            ...
            "scripts/protocol_lab_wave4e7_story_polish.py",
            "scripts/tests/test_protocol_lab_wave4e7_story_polish.py",
        ]:
        ...
        self.assertIn("Wave 4E7", changed_manifest)
        self.assertIn("src/pages/Home.tsx", changed_manifest)
        self.assertIn("packet-local replay", packet_readme.lower())
        self.assertIn("Company / LLY", render_preview)
        self.assertIn("Fresh vs reused", render_preview)
        ...
        self.assertIn("whether story-consistency QA was added or expanded: yes", console_text)
        self.assertIn(
