...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    prompt_lines = [
        ...
        "",
        "SYSTEM: You are a careful analyst. Use only the provided paragraphs.",
        ...
        "- max 350 characters per snippet.",
        "- artifacts.selected_prev and artifacts.selected_curr must list focuspack positions (0-based).",
        "",
